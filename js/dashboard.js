...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!userManager.syncCurrentUser()) {
        console.log('Synchronisation échouée, redirection vers login');
        window.location.href = 'login.html';
        return;
    }
    ...
    console.log('Utilisateur connecté:', user.pseudo, 'Crédits:', user.credits);
